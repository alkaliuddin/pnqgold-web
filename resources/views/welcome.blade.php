...
<head>
    <meta charset="UTF-8">
    <title>{{ config('app.name') }} Sdn Bhd</title>
...
<body class="gradient leading-normal tracking-normal text-white" style="font-family: 'Source Sans Pro', sans-serif;">
        ...
        <div class="container mx-auto mt-0 flex w-full flex-wrap items-center justify-between py-2">
            ...
            <div class="z-20 mt-2 hidden w-full flex-grow bg-white p-4 text-black lg:mt-0 lg:flex lg:w-auto lg:items-center lg:bg-transparent lg:p-0" id="nav-content">
                <ul class="list-reset flex-1 items-center justify-end lg:flex">
                    ...
                    <li class="mr-3">
                        <a class="hover:text-underline inline-block py-2 px-4 font-bold text-black no-underline hover:text-gray-800" href="{{ route('guest.index') }}">Semak Aduan</a>
                    </li>
                    <li class="mr-3">
                        <a class="hover:text-underline inline-block py-2 px-4 font-bold text-black no-underline hover:text-gray-800" href="{{ route('dashboard') }}">Helpdesk</a>
                    </li>
                </ul>
                {{-- <button id="navAction" class="focus:shadow-outline mx-auto mt-4 transform rounded-full bg-white py-4 px-8 font-bold text-gray-800 opacity-75 shadow transition duration-300 ease-in-out hover:scale-105 hover:underline focus:outline-none lg:mx-0 lg:mt-0">
                    Helpdesk
                </button> --}}
            </div>
        </div>
    ...
    <div class="pt-24">
        <div class="container mx-auto flex flex-col flex-wrap items-center px-3 md:flex-row">
            ...
            <div class="flex w-full flex-col items-start justify-center text-center md:w-2/5 md:text-left">
                ...
                {{-- <button class="focus:shadow-outline mx-auto my-6 transform rounded-full bg-white py-4 px-8 font-bold text-gray-800 shadow-lg transition duration-300 ease-in-out hover:scale-105 hover:underline focus:outline-none lg:mx-0">
                    Subscribe
                </button> --}}
            </div>
            <!--Right Col-->
    ...
    <section class="border-b bg-white py-8">
        <div class="container m-8 mx-auto max-w-5xl">
            <h1 class="my-2 w-full text-center text-5xl font-bold leading-tight text-gray-800">
                Title
            </h1>
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full p-6 sm:w-1/2">
                    <svg class="mx-auto w-full sm:h-64" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path transform="translate(-11.5 -150.75)" d="M119.9,721.42c-3-5.51.4-12.27,4.29-17.18s8.61-10,8.51-16.29c-.15-9-9.7-14.31-17.33-19.09a84,84,0,0,1-15.56-12.51A22.8,22.8,0,0,1,95,650c-1.58-3.52-1.54-7.52-1.44-11.37q.51-19.26,1.91-38.49" fill="none" stroke="#3f3d56"
                        ...
                        <path transform="translate(-11.5 -150.75)"
                            ...
                            fill="#3f3d56" />
                        <path transform="translate(-11.5 -150.75)"
                            d="M548.32,532.86a.41.41,0,0,0-.51,0l-15.87,12.7a.42.42,0,0,0-.15.31v23.4a.21.21,0,0,0,.2.21h11a.21.21,0,0,0,.2-.21V555a.21.21,0,0,1,.21-.2h9.36a.2.2,0,0,1,.2.2v14.24a.21.21,0,0,0,.2.21h11a.21.21,0,0,0,.2-.21v-23.4a.4.4,0,0,0-.15-.31Z" fill="#3f3d56" />
                        <path transform="translate(-11.5 -150.75)"
                        ...
                        <path transform="translate(-11.5 -150.75)"
                            d="m1014 543.21a11.85 11.85 0 0 0 2 2.71 24.62 24.62 0 0 0 7.28 5.44 246.74 246.74 0 0 1 -25.93 3.86c0.92-3.24-0.29-6.7-1.91-9.64s-3.7-5.69-4.72-8.9l10.2 0.28c1.85 0 3.71 0.1 5.56 0 1.39-0.07 3.69-0.9 5-0.59 2.64 0.63 1.3 4.42 2.52 6.84z" fill="#ffc1c7" />
                        <path transform="translate(-11.5 -150.75)"
                        ...
                        <path transform="translate(-11.5 -150.75)"
                            d="M999.16,721.79a5.79,5.79,0,0,0,5.14,6l134.88,3.33a.41.41,0,0,0,.32-.11h0a.31.31,0,0,0,.11-.2l1.79-8.32a6.38,6.38,0,0,0,.13-1.44l-2.88-60.37a5.65,5.65,0,0,0-.84-2.8l-2-3.36a1.12,1.12,0,0,0-.25-.28,1,1,0,0,0-.61-.2l-127,1.89a5.8,5.8,0,0,0-5.71,5.53Z" fill="#3f3d56" />
            ...
            <div class="flex flex-col-reverse flex-wrap sm:flex-row">
                <div class="mt-6 w-full p-6 sm:w-1/2">
                    <svg class="mx-auto w-5/6 sm:h-64" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path transform="translate(-11.697 -13.011)" d="m333.9 579.53c45.809-122.16 458.5-257.52 458.5-257.52-58.602 14.857-180.35 171.68-180.35 171.68s-257.52-187.36-386.28-170.03c0 0 567.04 18.571 777.1 297.14" fill="none" opacity=".8" stroke="#ff6347" stroke-miterlimit="10"
                            stroke-width="2" />
    ...
    <section class="border-b bg-white py-8">
        <div class="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div class="flex w-full flex-shrink flex-grow flex-col p-6 md:w-1/3">
                <div class="flex-1 overflow-hidden rounded-t rounded-b-none bg-white shadow">
    ...
    <section class="container mx-auto mb-12 py-6 text-center">
        <h1 class="my-2 w-full text-center text-5xl font-bold leading-tight text-white">
            Call to Action
        </h1>
        <div class="mb-4 w-full">
            <div class="mx-auto my-0 h-1 w-1/6 rounded-t bg-white py-0 opacity-25"></div>
        </div>
            ...
            <div class="flex w-full flex-col py-6 md:flex-row">
                <div class="mb-6 flex-1 text-black">
                    <a class="text-2xl font-bold text-yellow-600 no-underline hover:no-underline lg:text-4xl" href="#">
                        <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 inline h-6 sm:h-8" alt="PNQ Gold Logo">
                        PNQ Gold
                    </a>
                </div>
                <div class="flex-1">
                    <p class="uppercase text-gray-500 md:mb-6">Pautan</p>
                ...
                <div class="flex-1">
                    <p class="uppercase text-gray-500 md:mb-6">Syarikat</p>
                    <ul class="list-reset mb-6">
                        <li class="mt-2 mr-2 inline-block md:mr-0 md:block">
                            <a href="#" class="text-gray-800 no-underline hover:text-pink-500 hover:underline">Mengenai Kami</a>
                        </li>
                        <li class="mt-2 mr-2 inline-block md:mr-0 md:block">
                            <a href="#" class="text-gray-800 no-underline hover:text-pink-500 hover:underline">Hubungi Kami</a>
                        </li>
                    </ul>
                </div>
            </div>
