                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="complaint_isd_code"
                                            name="complaint_isd_code" placeholder="Masuk Kod ISD"
                                            value="{{ old('complaint_isd_code') }}">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="asset_model" name="asset_model">
                                            ...
                                            <option value="Komputer Riba" {{ old('asset_model')=="Komputer Riba"
                                                ? 'selected' : '' }}>Komputer Riba</option>
                                            <option value="Printer" {{ old('asset_model')=="Printer" ? 'selected' : ''
                                                }}>Printer</option>
                                            <option value="Projektor" {{ old('asset_model')=="Projektor" ? 'selected'
                                                : '' }}>Projektor</option>
                                            <option value="Charging Cart" {{ old('asset_model')=="Charging Cart"
                                                ? 'selected' : '' }}>Charging Cart</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="complainant_name"
                                            name="complainant_name" placeholder="Masukkan Nama Pengadu"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="complainant_email"
                                            name="complainant_email" placeholder="Masukkan Emel Pengadu"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="complainant_phone"
                                            name="complainant_phone" placeholder="Masukkan No. Telefon Pengadu"
