        ...
        <div class="container flex flex-wrap items-center justify-between w-full py-2 mx-auto mt-0">
            ...
            <div class="z-20 flex-grow hidden w-full p-4 mt-2 text-black bg-white lg:mt-0 lg:flex lg:w-auto lg:items-center lg:bg-transparent lg:p-0" id="nav-content">
                <ul class="items-center justify-end flex-1 list-reset lg:flex">
                    ...
                    <li class="mr-3">
                        <a class="inline-block px-4 py-2 font-bold text-black no-underline hover:text-underline hover:text-gray-800" href="{{ route('guest.index') }}">Semak Aduan</a>
                    </li>
                    <li class="mr-3">
                        <a class="inline-block px-4 py-2 font-bold text-black no-underline hover:text-underline hover:text-gray-800" href="{{ route('dashboard') }}">Helpdesk</a>
                    </li>
                </ul>
                {{-- <button id="navAction"
                    class="px-8 py-4 mx-auto mt-4 font-bold text-gray-800 transition duration-300 ease-in-out transform bg-white rounded-full shadow opacity-75 focus:shadow-outline hover:scale-105 hover:underline focus:outline-none lg:mx-0 lg:mt-0">
                    Helpdesk
                </button> --}}
            </div>
        </div>
    ...
    <div class="pt-24">
        <div class="container flex flex-col flex-wrap items-center px-3 mx-auto md:flex-row">
            ...
            <div class="flex flex-col items-start justify-center w-full text-center md:w-2/5 md:text-left">
                ...
                {{-- <button
                    class="px-8 py-4 mx-auto my-6 font-bold text-gray-800 transition duration-300 ease-in-out transform bg-white rounded-full shadow-lg focus:shadow-outline hover:scale-105 hover:underline focus:outline-none lg:mx-0">
                    Subscribe
                </button> --}}
            </div>
            <!--Right Col-->
                ...
                <div class="w-full p-6 sm:w-1/2">
                    <svg class="w-full mx-auto sm:h-64" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path transform="translate(-11.5 -150.75)"
                            ...
                            opacity=".1" />
                        <path transform="translate(-11.5 -150.75)"
                            d="M106,694.38a14,14,0,0,0,25.59-11.45,13.84,13.84,0,0,0-3.08,2.75c-1.34,1.62-2.22,3.47-3.76,5-2.87,2.82-7.5,4-11.63,4.09A60,60,0,0,1,106,694.38Z" opacity=".1" />
                        ...
                        <path transform="translate(-11.5 -150.75)" d="M387.5,490A66.5,66.5,0,1,1,321,423.5,66.47,66.47,0,0,1,387.5,490Z" fill="none" stroke="#f2f2f2" stroke-miterlimit="10"
                            stroke-width="2" />
                        <path transform="translate(-11.5 -150.75)" d="M325.38,467.23l8.3,13,35.53,55.59a66.5,66.5,0,0,1-103.32-8.57l43.54-84.94.91,1.43" fill="none" stroke="#f2f2f2"
                        ...
                        <path transform="translate(-11.5 -150.75)"
                            ...
                            fill="#3f3d56" />
                        <path transform="translate(-11.5 -150.75)"
                            d="M1135.53,654.27l4,76.78h0l.11-.2,1.79-8.32a6.38,6.38,0,0,0,.13-1.44l-2.88-60.37a5.65,5.65,0,0,0-.84-2.8l-2-3.36A1.12,1.12,0,0,0,1135.53,654.27Z" opacity=".1" />
                        <path transform="translate(-11.5 -150.75)"
                        ...
                        <path transform="translate(-11.5 -150.75)"
                            ...
                            fill="#cbceda" />
                        <path transform="translate(-11.5 -150.75)"
                            d="m990.71 553.1s20.5-12.81 37.59 0 28.48 71.2 28.48 71.2l-39.59-8.83s-1.7-6.83-4-8-2.57-6-2.57-6-12.24-3.7-11.39-17.94-8.52-30.43-8.52-30.43z" fill="#ff6584" />
                ...
                <div class="w-full p-6 mt-6 sm:w-1/2">
                    <svg class="w-5/6 mx-auto sm:h-64" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path transform="translate(-11.697 -13.011)"
                            ...
                            fill="#3f3d56" />
                        <path transform="translate(-11.697 -13.011)" d="m1002.9 620.79s-273.2-156.82-390.82-127.11c0 0-249.27 26.825-278.15 85.84 0 0-79.237-247.61-108.12-255.87" fill="none"
                            opacity=".8" stroke="#ff6347" stroke-miterlimit="10" stroke-width="2" />
                        <path transform="translate(-11.697 -13.011)"
                            d="m333.9 579.53c45.809-122.16 458.5-257.52 458.5-257.52-58.602 14.857-180.35 171.68-180.35 171.68s-257.52-187.36-386.28-170.03c0 0 567.04 18.571 777.1 297.14" fill="none"
                            opacity=".8" stroke="#ff6347" stroke-miterlimit="10" stroke-width="2" />
            ...
            <div class="flex flex-col flex-grow flex-shrink w-full p-6 md:w-1/3">
                ...
                <div class="flex-none p-6 mt-auto overflow-hidden bg-white rounded-t-none rounded-b shadow">
                    <div class="flex items-center justify-start">
                        <button
                            class="px-8 py-4 mx-auto my-6 font-bold text-white transition duration-300 ease-in-out transform rounded-full shadow-lg gradient focus:shadow-outline hover:scale-105 hover:underline focus:outline-none lg:mx-0">
                            Action
                        </button>
                    </div>
                </div>
    ...
    <footer class="bg-white">
        <div class="container px-8 mx-auto">
            <div class="flex flex-col w-full py-6 md:flex-row">
                ...
                <div class="flex-1">
                    <p class="text-gray-500 uppercase md:mb-6">Pautan</p>
                ...
                <div class="flex-1">
                    <p class="text-gray-500 uppercase md:mb-6">Syarikat</p>
                    <ul class="mb-6 list-reset">
                        <li class="inline-block mt-2 mr-2 md:mr-0 md:block">
                            <a href="#" class="text-gray-800 no-underline hover:text-pink-500 hover:underline">Mengenai
                                Kami</a>
                        </li>
                        <li class="inline-block mt-2 mr-2 md:mr-0 md:block">
                            <a href="#" class="text-gray-800 no-underline hover:text-pink-500 hover:underline">Hubungi
                                Kami</a>
                        </li>
                    </ul>
                </div>
