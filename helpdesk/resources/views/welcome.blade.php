        ...
        <div class="container flex flex-wrap items-center justify-between w-full py-2 mx-auto mt-0">
            ...
            <div class="z-20 flex-grow hidden w-full p-4 mt-2 text-black bg-white lg:mt-0 lg:flex lg:w-auto lg:items-center lg:bg-transparent lg:p-0"
                ...
                <ul class="items-center justify-end flex-1 list-reset lg:flex">
                    <li class="mr-3">
                        <a class="inline-block px-4 py-2 font-bold text-black no-underline hover:text-underline hover:text-gray-800"
                            href="{{ route('welcome') }}">Utama</a>
                    </li>
                    <li class="mr-3">
                        <a class="inline-block px-4 py-2 font-bold text-black no-underline hover:text-underline hover:text-gray-800"
                            href="{{ route('guest.index') }}">Semak Aduan</a>
                    </li>
                    <li class="mr-3">
                        <a class="inline-block px-4 py-2 font-bold text-black no-underline hover:text-underline hover:text-gray-800"
                            href="{{ route('dashboard') }}">Helpdesk</a>
                    </li>
                </ul>
                {{-- <button id="navAction"
